...
import { Hotel, Mail, Lock, AlertCircle, Loader2 } from 'lucide-react'
...
export const Login = () => {
  ...
  return (
    <div 
      // --- CAMBIO AQUÍ: Restamos la altura del Navbar para centrarlo perfecto ---
    ...
    >
      ...
      >
        ...
        <button onClick={() => navigate('/')} className="absolute top-4 right-4 text-slate-400 hover:text-slate-600 transition-colors">
        ...
        {error && (
          <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg flex items-center space-x-2 text-red-700 text-sm">
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm"><span className="px-2 bg-white text-slate-500">O continuar con</span></div>
          </div>
